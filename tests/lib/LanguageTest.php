...
class LanguageTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_()
    {
        ...
        $this->assertSame('The blue car is fast.', Language::_('LanguageTest.b', true, 'blue', 'fast', 'car'));
    }
    ...
    public function testGetText()
    {
        ...
        $this->assertSame('The blue car is fast.', Language::getText('LanguageTest.b', true, 'blue', 'fast', 'car'));

        $this->assertSame('I like the color green.', Language::getText('LanguageTest.a', true));

        Language::setLang('en_uk');
        $this->assertSame('The blue car is fast.', Language::getText('LanguageTest.b', true, 'blue', 'fast', 'car'));

        Configure::set('Language.allow_pass_through', true);
        $this->assertSame('Non-existent', Language::getText('Non-existent', true));
    ...
    {
        Language::loadLang('language_test', 'en_uk', $this->lang_path);
        Language::loadLang(['language_test', 'language_not_exists'], 'en_uk', $this->lang_path);

        Language::setLang('en_us');
        $this->assertSame('I like the color green.', Language::getText('LanguageTest.a', true));

        Language::setLang('en_uk');
        $this->assertSame('I like the colour green.', Language::getText('LanguageTest.a', true));
    }
    ...
    public function testSetLang()
    {
        ...
        $this->assertSame('en_uk', Language::setLang('en_us'));
    }
}
