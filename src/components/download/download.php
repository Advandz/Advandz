 ...
 *
 * @package Advandz
 * @subpackage Advandz.components.download
...
class Download {
	 ...
	 *
	 * @param mixed $content_type A numerically indexed array of content types to set, or a string containing the
	 *     content type to set
	 */
	 ...
	 * @param string $send_mode The send mode for the file (file to send normally, xsendfile to send through
	 *     mod_xsendfile)
	 */
