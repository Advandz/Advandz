...
class Pagination extends Html
{
    ...
    /**
     * @var bool Whether or not to return output from various pagination methods
     */
     ...
     *
     * @return bool True if pagination should be shown, false otherwise
     */
     ...
     *
     * @param bool $return True to return output from these form methods, false to echo results instead
     */
