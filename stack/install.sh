...
if [ "${option}" = "1" ]; then
    ...
    if [ "${type}" = "M" ]; then
...

        {
            ...
            echo " ";
            echo "[Service]";
            echo "ExecStart=/usr/local/bin/hhvm --config /etc/hhvm/server.ini --user lighttpd --mode daemon -vServer.Type=fastcgi -vServer.Port=9001";
            echo " ";
            echo "[Install]";
        ...
        # Install Open Lite Speed
        clear;
        echo "==================================";
        echo " Installing Open Lite Speed...";
        echo "==================================";
        yum -y remove nginx
        yum -y remove httpd
        yum -y remove lighttpd
        yum -y remove openlitespeed
        yum -y remove litespeed
        yum -y erase httpd nginx lighttpd openlitespeed litespeed
        rpm -ivh http://rpms.litespeedtech.com/centos/litespeed-repo-1.1-1.el7.noarch.rpm
        yum -y update
        yum -y install openlitespeed
        #yum -y install lsphp56 lsphp56-common lsphp56-mysql lsphp56-gd lsphp56-process lsphp56-mbstring lsphp56-xml lsphp56-mcrypt lsphp56-pdo lsphp56-imap lsphp56-soap lsphp56-bcmath
        ...
        /usr/local/lsws/bin/openlitespeed start
        /usr/local/lsws/bin/openlitespeed status
        systemctl enable radan-http.service
...

        {
            ...
            echo "## -----------------";
            echo "##";
            echo "## at least mod_access and mod_accesslog should be loaded";
            echo "## all other module should only be loaded if really neccesary";
            echo "##";
            echo "## - saves some time";
            echo "## - saves memory";
            echo "##";
            echo "## the default module set contains:";
            echo "##";
            echo "## \"mod_indexfile\", \"mod_dirlisting\", \"mod_staticfile\"";
            echo "##";
            echo "## you dont have to include those modules in your list";
            echo "##";
            echo "## Modules, which are pulled in via conf.d/*.conf";
            echo "##";
            echo "## NOTE: the order of modules is important.";
            echo "##";
            echo "## - mod_accesslog     -> conf.d/access_log.conf";
            echo "## - mod_compress      -> conf.d/compress.conf";
            echo "## - mod_status        -> conf.d/status.conf";
            echo "## - mod_webdav        -> conf.d/webdav.conf";
            echo "## - mod_cml           -> conf.d/cml.conf";
            echo "## - mod_evhost        -> conf.d/evhost.conf";
            echo "## - mod_simple_vhost  -> conf.d/simple_vhost.conf";
            echo "## - mod_mysql_vhost   -> conf.d/mysql_vhost.conf";
            echo "## - mod_trigger_b4_dl -> conf.d/trigger_b4_dl.conf";
            echo "## - mod_userdir       -> conf.d/userdir.conf";
            echo "## - mod_rrdtool       -> conf.d/rrdtool.conf";
            echo "## - mod_ssi           -> conf.d/ssi.conf";
            echo "## - mod_cgi           -> conf.d/cgi.conf";
            echo "## - mod_scgi          -> conf.d/scgi.conf";
            echo "## - mod_fastcgi       -> conf.d/fastcgi.conf";
            echo "## - mod_proxy         -> conf.d/proxy.conf";
            echo "## - mod_secdownload   -> conf.d/secdownload.conf";
            echo "## - mod_expire        -> conf.d/expire.conf";
            echo "##";
            echo " ";
            echo "server.modules = (";
            echo "  \"mod_access\",";
            ...
            echo "#######################################################################";
            echo "##";
            echo "##  Config for various Modules";
            echo "##";
            echo " ";
            echo "##";
            echo "## mod_ssi";
            echo "##";
            echo "#include \"conf.d/ssi.conf\"";
            echo " ";
            echo "##";
            echo "## mod_status";
            echo "##";
            echo "#include \"conf.d/status.conf\"";
            echo " ";
            echo "##";
            echo "## mod_webdav";
            echo "##";
            echo "#include \"conf.d/webdav.conf\"";
            echo " ";
            echo "##";
            echo "## mod_compress";
            echo "##";
            echo "#include \"conf.d/compress.conf\"";
            echo " ";
            echo "##";
            echo "## mod_userdir";
            echo "##";
            echo "#include \"conf.d/userdir.conf\"";
            echo " ";
            echo "##";
            echo "## mod_magnet";
            echo "##";
            echo "#include \"conf.d/magnet.conf\"";
            echo " ";
            echo "##";
            echo "## mod_cml";
            echo "##";
            echo "#include \"conf.d/cml.conf\"";
            echo " ";
            echo "##";
            echo "## mod_rrdtool";
            echo "##";
            echo "#include \"conf.d/rrdtool.conf\"";
            echo " ";
            echo "##";
            echo "## mod_proxy";
            echo "##";
            echo "#include \"conf.d/proxy.conf\"";
            echo " ";
            echo "##";
            echo "## mod_expire";
            echo "##";
            echo "#include \"conf.d/expire.conf\"";
            echo " ";
            echo "##";
            echo "## mod_secdownload";
            echo "##";
            echo "#include \"conf.d/secdownload.conf\"";
            echo " ";
            echo "##";
            echo "#######################################################################";
            echo " ";
            ...
            echo "## SCGI (mod_scgi)";
            echo "##";
            echo "#include \"conf.d/scgi.conf\"";
            echo " ";
            echo "##";
            echo "## FastCGI (mod_fastcgi)";
            echo "##";
            echo "include \"conf.d/fastcgi.conf\"";
            echo " ";
            echo "##";
            echo "## plain old CGI (mod_cgi)";
            echo "##";
            echo "#include \"conf.d/cgi.conf\"";
            echo " ";
            echo "##";
            echo "#######################################################################";
            echo " ";
            ...
            echo "## VHost Modules";
            echo "##";
            echo "##  Only load ONE of them!";
            echo "## ========================";
            echo "##";
            echo " ";
            echo "##";
            echo "## You can use conditionals for vhosts aswell.";
            echo "## ";
            echo "## see http://www.lighttpd.net/documentation/configuration.html";
            echo "##";
            echo " ";
            echo "##";
            echo "## mod_evhost";
            echo "##";
            echo "#include \"conf.d/evhost.conf\"";
            echo " ";
            echo "##";
            echo "## mod_simple_vhost";
            echo "##";
            echo "#include \"conf.d/simple_vhost.conf\"";
            echo " ";
            echo "##";
            echo "## mod_mysql_vhost";
            echo "##";
            echo "#include \"conf.d/mysql_vhost.conf\"";
            echo " ";
            echo "##";
            echo "#######################################################################";
